...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
  ...
  if ($hapus) {
    ...
    echo "<script>alert('Gagal menghapus data'); window.location='tampil_barang.php';</script>";
  }
} else {
  echo "<script>alert('ID tidak valid'); window.location='tampil_barang.php';</script>";
}